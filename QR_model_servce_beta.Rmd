...
QR_Policy_alpha <- function(d, sdd, lt, sdlt, u = 0, sdu = 0, k, h, c, alpha = 0.95){
...
```{r}
QR_Policy_alpha(d = 1200, sdd = 300, lt = 120, sdlt = 60, k = 800, h = 0.15, c = 300,  alpha = 0.95)
```



```{r}
QR_Policy_beta <- function(d, sdd, lt, sdlt, u = 0, sdu = 0, k, h, c, p, iter = 20){
...
```{r}
result = QR_Policy_beta(d = 28, sdd = 14, lt = 120, sdlt = 60, k = 800, h = 0.3, c = 50, p = 99.66)
```
